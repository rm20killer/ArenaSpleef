...
public final class SpleefMessages {
    public static final Message LAYER_SET_MIN_POSITION = Messages.info("spleef-editor-layer-set-min-position", "Click a block to set the minimum (first) position of the layer.");
    ...
    public static final Message LAYER_REMOVED_ALL = Messages.success("spleef-layer-removed-all", "All layers removed successfully!");
    public static final Message LAYER_INDEX_CHANGED = Messages.success("spleef-layer-index-changed", "Layer index changed successfully!");
